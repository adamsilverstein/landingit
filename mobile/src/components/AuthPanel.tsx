...
export function AuthPanel({ onSave }: AuthPanelProps) {
  ...
  if (mode === 'oauth' && oauthAvailability.available) {
    return (
      <OAuthCard
        state={oauthState}
